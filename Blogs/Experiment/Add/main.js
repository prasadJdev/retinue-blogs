  ...
  inputTag.addEventListener('change', function() {
    ...
    if (file) {
      ...
      reader.addEventListener('load', function() {
        ...
        // Ajax File uploading On 'upload_btn' Clicked
     upload_btns = document.querySelectorAll('.upload_btn');
     upload_btns.forEach(upload_btn=>{
     upload_btn.addEventListener('click',function () {
         // Ajax Uploading 
         const xhr = new XMLHttpRequest();
         const formData = new FormData();
         for (const file of currentInputTag.files){
